...
ActiveRecord::Schema.define(version: 2020_07_05_012858) do
  ...
  create_table "responses", force: :cascade do |t|
    t.integer "answerererer_id", null: false
    t.integer "answer_choice_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["answer_choice_id"], name: "index_responses_on_answer_choice_id"
    t.index ["answerererer_id"], name: "index_responses_on_answerererer_id"
  end
